<div class="fullscreen">
  ...
  <form action="change-details" method="post">
    ...
    <input class="details-form" type="text" name="firstname"/>
    <label class="details-form" >Surname</label>
    <input class="details-form"  type="text" name="surname"/>
    <label class="details-form" >Term Address</label>
    <input class="details-form"  type="text" name="term_address_line1"/>
    <input class="details-form"  type="text" name="term_address_line2"/>
    <label class="details-form" >Home Address</label>
    <input class="details-form"  type="text" name="haddress"/>
    <label class="details-form" >Email Address</label>
    <input class="details-form"  type="text" name="email"/>
    <label class="details-form" >Mobile Number</label>
    <input class="details-form" type="text" name="phone-num"/>
    <br>
